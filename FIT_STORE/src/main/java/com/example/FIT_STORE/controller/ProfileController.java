...
public class ProfileController {
	...
	public String deleteClient(ModelMap model,@RequestParam int id) {
	    UserReg nt = up.findById(id);

	    if (nt != null) {
	        up.delete(nt);
	        model.put("msg","Profile deleted!");
	    }
	...
	@GetMapping("/Editpro")
	public String editpro(Model model,@RequestParam int id) {
	    ...
	    UserReg Dto = new  UserReg();
	  //  clientDto.setId(ntr.getId());
	    Dto.setName(ntr.getName());
	    Dto.setEmail(ntr.getEmail());
	    Dto.setAge(ntr.getAge());
	    Dto.setGender(ntr.getGender());
	    Dto.setHeight(ntr.getHeight());
	    Dto.setWeight(ntr.getWeight());
	    Dto.setPhnno(ntr.getPhnno());
	...
	public String editpro(
	    ...
	    @Validated @ModelAttribute UserReg Dto,
	...
	public String editClient(Model model) {
	  ...
	  //  clientDto.setId(ntr.getId());
	    ...
	    clientDto.setPassword(ntr.getPassword());
