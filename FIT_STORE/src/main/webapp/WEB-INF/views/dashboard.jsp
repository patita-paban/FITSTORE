...
<div class="container mt-4">
    <h2 class="mb-4">Welcome to FitStore ${name}!</h2>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-primary h-100">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3">10,542</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-white bg-success h-100">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3">1,240 kcal</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-white bg-danger h-100">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3">76 bpm</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const activityChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Calories',
                data: [8500, 9200, 4000, 7500, 10400, 9800, 12000],
                fill: false,
