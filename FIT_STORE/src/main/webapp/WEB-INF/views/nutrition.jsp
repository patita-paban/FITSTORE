...
<div class="container mt-4">
    ...
    <div class="card p-4 mb-4">
        <form action="addNut" method="post">
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <select id="mealType" name="mealType" class="form-select" required>
                ...
                <div class="col-12">
                    ...
                    <input type="text" id="description" name="description" class="form-control"  placeholder="E.g. Chicken salad, apple, water" required>
                </div>
                <div class="col-12">
                    <button class="btn btn-success mt-2" type="submit">Add Meal</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="card p-4">
        ...
        <table class="table table-striped mt-3">
            ...
            <!-- Example Static Rows -->
           <%
           Nutrition nt= new Nutrition();
           List<Nutrition> Nut =( List<Nutrition>)request.getAttribute("nut_item");
                    		if(Nut!=null && !Nut.isEmpty()){
                    			for(Nutrition no:Nut)
                    			{
           ...
           %>
            ...
            <td><%=no.getDate() %></td>
             <td><%=no.getMeal() %></td>
             <td><%=no.getMeal_des() %></td>
             <td><%=no.getCalories() %></td>
             <td><%=no.getWater() %></td>
             
             <td><a class="btn btn-primary btn-sm"
                  id=<%=no.getId() %>
                  href="editNu?id=<%=no.getId()%>">
